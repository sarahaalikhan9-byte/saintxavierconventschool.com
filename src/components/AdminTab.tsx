...
type AdminTool =
  ...
  | 'social_media' | 'announcements' | 'security';
...
const tools = [
  ...
  { id: 'camera',           label: 'AI Camera System',    icon: Camera,          color: 'text-red-500',     accent: '#EF4444', bg: 'bg-red-500/10',     desc: 'Surveillance & AI detection feeds' },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
        {tools.map(tool => (
          <button
            ...
            className={`group p-5 rounded-2xl border text-left transition-all duration-200 hover:scale-[1.02] hover:-translate-y-1 ${
              isGlass
